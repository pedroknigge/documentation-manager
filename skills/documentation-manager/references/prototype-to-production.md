...
| Definition of Done | **generates** | plan / feature Acceptance criteria; [quality-checklist.md](quality-checklist.md) is the *skill’s* docs bar | Proposal AC. Not a signed production DoD. |
...
User mentions prototipo a producción, Apéndice A, production checklist, Gate A/B, SEV runbooks, or threat model — load **this page**. Do not invent missing artifacts.
