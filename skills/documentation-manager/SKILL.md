...
description: >
  v2.5.14 — Use when bootstrapping, completing, updating, or auditing project documentation,
  ...
  "states/transitions", "cold-agent", "provenance", /documentation-manager. Intents:
