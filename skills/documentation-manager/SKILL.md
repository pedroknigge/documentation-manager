...
description: >
  v2.5.9 — Use when bootstrapping, completing, updating, or auditing project documentation,
...
20. **v2.0 package.** Completes the 10× line: capabilities 1.4–1.7 plus [docs/adoption-matrix.md](../../docs/adoption-matrix.md) tracking. Baseline install floor remains **2.0.0**; polyglot **2.1.0**; monorepo **2.2.0**; team **2.3.0**; Bridge complete **2.4.0**; Knowledge OS first increment **2.5.0**; current line is **2.5.9+** (catch-up on that floor — living claims + CI audit + go/no-go trail + Appendix A + §2 Mínimo + production-harden DoD + Sólido states/transitions; not a second 10×).
...
| [references/quality-checklist.md](references/quality-checklist.md) | Done criteria (incl. **§2 Mínimo** + go/no-go + Appendix A + **production-harden DoD** + **Sólido states/transitions**) |
