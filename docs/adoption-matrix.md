...
**Last updated:** 2026-09-18 · Skill version **2.5.21**
...
| Pstack plan bridge (bake + HITL) | **2.5.19** | [pstack-bridge.md](../skills/documentation-manager/references/pstack-bridge.md) · [modes.md §22](../skills/documentation-manager/references/modes.md#22-pstack-plan-bridge) — bake always; no silent auto-run; not a product merge |
